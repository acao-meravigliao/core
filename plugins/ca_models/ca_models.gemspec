...
Gem::Specification.new do |spec|
  spec.name          = 'ca_models'
  spec.version       = CaModels::VERSION
  spec.authors       = ['Daniele Orlandi']
  spec.email         = ['daniele@orlandi.com']
  spec.summary       = %q{Certification Authority models}
  spec.description   = %q{Certification Authority models}
  ...
  spec.add_runtime_dependency 'json-jwt', '>= 1.9.4'
end
