...
require 'ca_hel/version'

Gem::Specification.new do |spec|
  spec.name          = 'ca_hel'
  spec.version       = CaHel::VERSION
  spec.authors       = ['Daniele Orlandi']
  spec.email         = ['daniele@orlandi.com']
  spec.summary       = %q{Certification Authority controllers}
  spec.description   = %q{Certification Authority controllers}
