class ReplicasTasksToUuid < ActiveRecord::Migration[6.0]
  def up
    # ----------

    rename_column 'core.replicas', 'obj_id', 'obj_id_old'
    add_column 'core.replicas', 'obj_id', :uuid
    change_column_null 'core.replicas', 'obj_id_old', true
